...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="b">
      ...
      <a href="Nurse.php"><button  type="submit" class="Nurse">Nurse</button></a>
    </div>
    <br>
    ...
    <form class="" name="" method="post">
      <div class="container">
        <div class="pic">
        <img src="photos/Receptionist.png" alt="Login icon">
        </div><br>
        <h1 class="header_R">Receptionist</h1>
   ...
   <input id="text" type="text" name="Date_of_birth" placeholder="Enter Date_of_birth   'YYYY-MM-DD'" required><br>
       ...
       <button type="submit" name="Delete" class="cancelbtn">Delete</button>
        ...
        <p>*note that to update a Receptionist you can only use his/her id to update name, salary etc</p>
    ...
    session_start();
      ...
      if(isset($_POST["Insert"]))
      {
        ...
        mysqli_query($con,"insert into receptionist (user_id) values ('$id')");
      }
    ...
    $res = mysqli_query($con,"select r.user_id,user_name,email_address,date_of_birth,salary from user u join receptionist r on u.user_id = r.user_id");
